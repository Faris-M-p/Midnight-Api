...
public class AccessTokenSecretGenerator : IAccessTokenSecretGenerator
{
    ...
    /// </summary>
    public string GenerateRawToken(string? familyCode, int secretLength = 20)
    {
    ...
    public string PrefixFromFamilyCode(string? familyCode)
    {
    ...
    public bool MatchesFamilyPrefix(string rawToken, string? familyCode)
    {
        var prefix = PrefixFromFamilyCode(familyCode);
    ...
    /// </summary>
    public bool TryParse(string? rawToken, out string familyCodePrefix, out string secret)
    {
    ...
    public string BuildPreview(string rawToken)
    {
        if (string.IsNullOrWhiteSpace(rawToken))
        {
            return "••••••••";
    ...
    public DateTimeOffset ResolveExpiresOn(string expiryPreset, DateTimeOffset? customExpiresOn)
    {
    ...
    public string InferPreset(DateTimeOffset expiresOn)
    {
